...
#define calibration_factor -1900.00 //This value is obtained using the SparkFun_HX711_Calibration sketch
...
void setup() {
  ...
  //pinMode(switchSPI, OUTPUT);
  //digitalWrite(switchSPI, LOW);
